...
class RecipeRepository {
    ...
    fun loadRecipeList(resultCallback: RecipeViewModel.OnResultCallback) {
        mApiServices.recipes.enqueue(RecipesResponseCallback(resultCallback))
    }
    ...
    fun getAllRecipesByQuery(query: String,
                             onSearchResultCallback: RecipeViewModel.OnResultCallback) {
    ...
    private inner class SearchResponseCallback(private val searchResultCallback:
        ...
        override fun onResponse(call: Call<RecipeResponse>, response: Response<RecipeResponse>) {
            ...
            if (response.isSuccessful) {
                ...
                if (meals != null && meals.recipes != null) {
